...
public class LinkedlList {
	 ...
	 * node================================
	 */
	// declaring it as inner class because node have no independent existence,
	// it exists inside a linked list , so , created it as inner class.
	static class Node {
	...
	public void adjecentSwap(Node swap) {
		...
		while (true) {
			...
			// pointing the previous node to the node after next as after
			// swapping it will be new node
			prev.next = next.next;
