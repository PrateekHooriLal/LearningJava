...
/**
 * Altimetrik / Airbnb L1 Interview — Stream Problems
 * Notes: Interview/notes/AltimetrikInterviewNotes.md
 */
public class AltimetrikStreams {
    ...
    // Algorithm: frequency array per word -> take MIN across all words -> expand to list
